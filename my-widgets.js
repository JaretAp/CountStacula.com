Function && Function.prototype && Function.prototype.bind && (/(MSIE ([6789]|10|11))|Trident/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(),
  window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function (t) {
    ...
    , function (t, e, n) {
      ...
      t.exports = {
        ...
        embedIframe: function (t, e) {
          ...
          return a && d(c, a) ? h(a, n) + ".html" : (n.unshift(i.getBaseURLPath(e)),
            h(o, n) + ".html")
        },
        embedService: function (t) {
          var e = t || []
            , n = o;
          return e.unshift("srv"),
            h(n, e)
        },
      ...
      r = function () {
        ...
        function N(e, n, r) {
          n.constructor === e.constructor && r === y && n.constructor.resolve === b ? function (t, e) {
            ...
            A.error = null) : void 0 === r ? P(e, n) : t(r) ? function (t, e, n) {
              o(function (t) {
                var r = !1
                  , i = function (t, e, n, r) {
                    try {
        ...
        function C(t, e) {
          var n, r;
          t === e ? j(t, new TypeError("You cannot resolve a promise with itself")) : (r = typeof (n = e),
            ...
            this._instanceConstructor = t,
              ...
              e(n) ? (this.length = n.length,
                ...
                0 === this.length ? P(this.promise, this._result) : (this.length = this.length || 0,
                  this._enumerate(n),
                  0 === this._remaining && P(this.promise, this._result))) : j(this.promise, new Error("Array Methods must be provided an Array"))
          }
    ...
    , function (t, e, n) {
      var r, i = n(10), o = n(4), s = n(1), a = n(34), u = n(51), c = n(5), d = n(21), f = "csptest";
      t.exports = {
        ...
        if (!d && !f)
          return c && c(arguments),
            s.getExperiments().then(function (s) {
              s && s.tfw_duplicate_scribes_to_settings && "on" === s.tfw_duplicate_scribes_to_settings.bucket ? ((e = e || {}).context = "rufous-eol",
                m(o.formatClientEventNamespace(t), o.formatClientEventData(e, n, r), a.settingsScribe(), i)) : m(o.formatClientEventNamespace(t), o.formatClientEventData(e, n, r), o.CLIENT_EVENT_ENDPOINT, i)
            })
      }
      function m(t, e, n, s) {
        var a;
        n && u.isObject(t) && u.isObject(e) && (r.log(t, e),
      ...
      t.exports = {
        ...
        enqueueClientEvent: function (t, e, n, r) {
          var i = !u.isObject(t)
            , s = !!e && !u.isObject(e);
          if (!i && !s)
            return v(o.flattenClientEventPayload(o.formatClientEventNamespace(t), o.formatClientEventData(e, n, r)))
        },
        interaction: function (t, e, n, r) {
          var i = o.extractTermsFromDOM(t.target || t.srcElement);
          return i.action = r || "click",
            p(i, e, n)
        },
        placePixel: g
      }
    ...
    , , , , , , , , function (t, e, n) {
      var r, i = n(3), o = n(4), s = n(84), a = n(46), u = n(9), c = n(85), d = n(22), f = n(88), l = n(143), h = n(151), p = n(152), m = n(26), v = n(27);
      n(153),
    ...
    , function (t, e, n) {
      var r, i, o, s = n(4), a = n(1), u = n(29), c = n(19), d = n(3), f = n(6), l = n(53), h = n(37), p = n(0), m = n(30), v = n(9).get("scribeCallback"), g = Math.floor(1e3 * Math.random()) + "_", w = "rufous-frame-" + g + "-", y = "rufous-form-" + g + "-", b = 0, _ = !1, E = new d;
      function x() {
      ...
      t.exports = {
        load: function () {
          ...
          if (u.ie9() || u.ie10() || "http:" !== d.protocol && "https:" !== d.protocol)
            return f.devError("Using default settings due to unsupported browser or protocol."),
              void y().resolve();
          t = {
            origin: d.origin
          },
        ...
        t.params({
          ...
          t.overrideProperty("endpoint", {
            get: function () {
              ...
              return this.params.id ? e.push("list-id", this.params.id) : (t = a(this.params),
        ...
        t.params({
          ...
          t.overrideProperty("endpoint", {
            get: function () {
              ...
              return e ? t.push("screen-name", e) : t.push("user-id", this.params.userId),
                s.embedService(t)
            }
          }),
    ...
    , function (t, e, n) {
      var r, i = n(0), o = n(67), s = n(15), a = (r = s(["tweetId"], {}, o),
        function () {
